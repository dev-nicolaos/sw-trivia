...
const trivia: QUESTION[] = [
  ...
  {
    question: `What type of blaster did the rebel troops on the Tantive IV use when boarded above Tatooine?`,
    correctAnswer: `DH-17`,
    wrongAnswers: [`DLT-19`, `A280C`, `E-11`],
    source: {name:`Episode IV: A New Hope`, mediaType:`Film`}
  },
  {
    question: `Who did Princess Leia give the stolen Death Star plans to above Tatooine?`,
    correctAnswer: `R2-D2`,
    wrongAnswers: [`C-3PO`, `Captain Antilles`, `Mon Mothma`],
    source: {name:`Episode IV: A New Hope`, mediaType:`Film`}
  },
  {
    question: `Where did C-3PO fear he and R2 would be taken and "smashed into who knows what"?`,
    correctAnswer: `The Spice Mines of Kessel`,
    wrongAnswers: [`The Imperial Palace on Coruscant`, `The Shipyards above Kuat`, `A junk dealer on Tatooine`],
    source: {name:`Episode IV: A New Hope`, mediaType:`Film`}
  },
  {
    question: `How many stormtroopers did Leia shoot before being stunned on the Tantive IV?`,
    correctAnswer: `1`,
    wrongAnswers: [`0`, `2`, `3`],
    source: {name:`Episode IV: A New Hope`, mediaType:`Film`}
  },
  {
    ...
    wrongAnswers: [`stupid little astromech!`, `pathetic excuse for a droid`, `piece of junk`],
    source: {name:`Episode IV: A New Hope`, mediaType:`Film`}
  },
  {
  ...
  {
    question: `Beru wanted Luke to make sure Owen bought a translator droid that spoke which language?`,
    correctAnswer: `Bocce`,
  ...
  },
  {
    ...
    wrongAnswers: [`have a drink with Biggs.`, `fly the new XP-38.`, `meet a pretty girl.`],
    source: {name:`Episode IV: A New Hope`, mediaType:`Film`}
  },
  {
    question: `Where was Luke supposed to take C-3PO and R2-D2 to wipe their memories?`,
  ...
  {
    question: `Which of the following was NOT a characteristic of the Force Obi-Wan shared with Luke?`,
    correctAnswer: `It gives the Sith their power`,
    wrongAnswers: [`It's an energy field`, `It's created by all living things`, `It binds the galaxy together`],
    source: {name:`Episode IV: A New Hope`, mediaType:`Film`}
  },
  {
    question: `Which Imperial aboard the Death Star announced that the Emperor had dissolved the Senate?`,
    correctAnswer: `Grand Moff Tarkin`,
    wrongAnswers: [`Admiral Motti`, `Darth Vader`, `Colonel Yularen`],
    source: {name:`Episode IV: A New Hope`, mediaType:`Film`}
  },
  {
    question: `What color was the pauldron of the stormtrooper that Obi-Wan tricked in Mos Eisley?`,
  ...
  {
    question: `Which bounty hunter cornered Han Solo in the Mos Eisley Cantina?`,
  ...
  },
  {
    ...
    wrongAnswers: [`play the long game.`, `go for the kill.`, `actually make an effort.`],
    source: {name:`Episode IV: A New Hope`, mediaType:`Film`}
  },
  {
    question: `What was the number of the stormtrooper on the Death Star whose armor Luke took?`,
  ...
  {
    question: `Finish the quote: "When I left you I was but the learner, now _____"`,
    correctAnswer: `I am the master.`,
    wrongAnswers: [`you will die.`, `I am more powerful than any Jedi.`, `the roles have reversed.`],
    source: {name:`Episode IV: A New Hope`, mediaType:`Film`}
  },
  {
  ...
  {
    question: `Why did the Millenium Falcon encounter minimal pursuit after escaping the first Death Star?`,
  ...
  {
    question: `What did Luke tell Wedge he used to "bullseye wamprats" with on Tatooine?`,
    correctAnswer: `His T-16`,
    wrongAnswers: [`His XP-34`, `His 6-2Aug2 Rifle`, `His X-Wing`],
    source: {name:`Episode IV: A New Hope`, mediaType:`Film`}
  },
  {
    question: `How close to firing range was the Death Star when rebel pilots took off from Yavin IV?`,
  ...
  {
    question: `How many guns did Gold 5 guess were guarding the trench on the Death Star?`,
  ...
  },
  {
    ...
    wrongAnswers: [`What are you, a fool?`, `I will not fail.`, `You will not stop me.`],
    source: {name:`Episode IV: A New Hope`, mediaType:`Film`}
  },
  {
    question: `What did C-3PO offer to donate to help fix R2 after the Battle of Yavin?`,
    correctAnswer: `His own circuits and gears`,
    wrongAnswers: [`His own earnings`, `His own expertise`, `His own coverings`],
    source: {name:`Episode IV: A New Hope`, mediaType:`Film`}
  },
];
