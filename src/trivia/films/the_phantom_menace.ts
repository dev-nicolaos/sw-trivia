...
const trivia: QUESTION[] = [
  {
    ...
    wrongAnswers: [
      `The Jedi Council`, `The Senate`, `The Trade Federation`
    ],
    source: {
  ...
  },
  {
    ...
    wrongAnswers: [
      `should be used sparingly.`, `is a beautiful gift.`, `is how liberty dies.`
    ],
    source: {
      name: `Star Wars Episode I: The Phantom Menace`,
      mediaType: `Film`
  ...
  },
  {
    ...
    wrongAnswers: [
      `Bypass the compressor`, `Replace the negative power coupling`, `Fire the emergency booster engines`
    ],
    source: {
      name: `Star Wars Episode I: The Phantom Menace`,
      mediaType: `Film`
  ...
  },
  {
    ...
    wrongAnswers: [
      `Scum and Villany`, `Pod Racers`, `Traders and Star Pilots`
    ],
    source: {
      name: `Star Wars Episode I: The Phantom Menace`,
      mediaType: `Film`
  ...
  },
  {
    ...
    correctAnswer: `Naked`,
    wrongAnswers: [
      `Mindless Philosopher`, `Professor`, `Golden Rod`
    ],
    source: {
      name: `Star Wars Episode I: The Phantom Menace`,
      mediaType: `Film`
  ...
  },
  {
    ...
    wrongAnswers: [
      `Ben Quadrinaros`, `Clegg Holdfast`, `Dud Bolt`
    ],
    source: {
      name: `Star Wars Episode I: The Phantom Menace`,
      mediaType: `Film`
  ...
  },
  {
    ...
    wrongAnswers: [
      `Wroshyr wood`, `Oka-wood`, `A Pizo stick`
    ],
    source: {
      name: `Star Wars Episode I: The Phantom Menace`,
      mediaType: `Film`
  ...
  },
  {
    ...
    wrongAnswers: [
      `The Represtative from Ryloth`, `The Senator from Alderaan`, `The Jedi Council`
    ],
    source: {
      name: `Star Wars Episode I: The Phantom Menace`,
      mediaType: `Film`
