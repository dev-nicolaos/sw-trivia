...
const trivia: QUESTION[] = [
  ...
  {
    question: `What was the doll that a Death Trooper found while searching the Erso home on Lah'mu?`,
  ...
  {
    question: `Finish the quote: "Congratulations, you are being rescued. _____"`,
    correctAnswer: `Please do not resist.`,
    wrongAnswers: [`You can thank me later.`, `We have a long ride ahead of us`, `Did I miss something?`],
    source: {name:`Rouge One: A Star Wars Story`, mediaType:`Film`}
  },
  {
    question: `What did Mon Mothma want to do if the Rebelion located Galen Erso?`,
    correctAnswer: `Return him to testify in the Senate`,
    wrongAnswers: [`Kill him`, `Turn him into a rebel agent`, `Get him to disable the Death Star`],
    source: {name:`Rouge One: A Star Wars Story`, mediaType:`Film`}
  },
  {
    question: `What starship did Captain Andor, Jyn, and K2SO take to Jedha?`,
    correctAnswer: `U Wing Gunship`,
    wrongAnswers: [`Imperial Cargo Transport`, `Imperial Shuttle`, `Alderaan Cruiser`],
    source: {name:`Rouge One: A Star Wars Story`, mediaType:`Film`}
  },
  {
    question: `Who was NOT on Jedha just before the Death Star destroyed Jedha City?`,
    correctAnswer: `Bail Organa`,
    wrongAnswers: [`Ponda Baba`, `Chirrut Îmwe`, `Edrio Two Tubes`],
    source: {name:`Rouge One: A Star Wars Story`, mediaType:`Film`}
  },
  {
    question: `How much was the Imperial reward for information leading to the location of Bodhi Rook?`,
  ...
  },
  {
    ...
    wrongAnswers: [`The Empire was approaching`, `The Death Star had fired`, `The Jedi were going to die`],
    source: {name:`Rouge One: A Star Wars Story`, mediaType:`Film`}
  },
  {
  ...
  {
    question: `Which landing pad on Scarif was cargo shuttle SW0608 cleared to land on?`,
    correctAnswer: `9`,
    wrongAnswers: [`12`, `5`, `4`],
    source: {name:`Rouge One: A Star Wars Story`, mediaType:`Film`}
  },
  ...
  {
    question: `Which squadron was sent to provide in atmosphere support during the Battle of Scarif?`,
    correctAnswer: `Blue Squadron`,
    wrongAnswers: [`Green Squadron`, `Red Squadron`, `Gold Squadron`],
    source: {name:`Rouge One: A Star Wars Story`, mediaType:`Film`}
  },
  {
    question: `What was the codename of the Death Star plans in the archive on Scarif?`,
