...
const trivia: QUESTION[] = [
  ...
  },
  {
    ...
    wrongAnswers: [`Stealing a shuttle`, `Taking over the ship`, `Pretending to join the rebelion`],
    source: {name:`Star Wars Battlefront 2`, mediaType:`Game`}
  },
  {
  ...
  },
  {
    ...
    wrongAnswers: [`The Administrator's Palace`, `The Carbon Freezing Chamber`, `Ugnorgrad`],
    source: {name:`Star Wars Battlefront 2`, mediaType:`Game`}
  },
  {
  ...
  },
  {
    ...
    wrongAnswers: [`Bombared it from a capitol ship`, `Y-Wing Bombing Runs`, `Put detonators inside`],
    source: {name:`Star Wars Battlefront 2`, mediaType:`Game`}
  },
  {
  ...
  },
  {
    ...
    wrongAnswers: [`Go now while you still can.`, `Go. Fight. Win.`, `Go and bring it to the galaxy.`],
    source: {name:`Star Wars Battlefront 2`, mediaType:`Game`}
  },
  {
